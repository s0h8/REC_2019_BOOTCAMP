  ...
  const myQuestions = [
    {
      ...
      answers: {
        ...
        d: "var a [10]int"                   ///// Write the option 4 inside double quotes
      },
      correctAnswer: "d"                ///// Write the correct option inside double quotes
    },

    {
      question: "Which of the following is a correct way to declare a multidimensional array in Java?",  ///// Write the question inside double quotes
      answers: {
        a: "int[] arr;",                  ///// Write the option 1 inside double quotes
        b: "int arr[[]];",                  ///// Write the option 2 inside double quotes
        c: "var arr[2][5] int",                  ///// Write the option 3 inside double quotes
        d: "int[[]] arr;"                   ///// Write the option 4 inside double quotes
      },
      correctAnswer: "c"                ///// Write the correct option inside double quotes
    },  
    {
      question: "What is the location of  first element is usually known as ?",  ///// Write the question inside double quotes
      answers: {
        a: "Base address",                  ///// Write the option 1 inside double quotes
        b: "array address",                  ///// Write the option 2 inside double quotes
        c: "element address",                  ///// Write the option 3 inside double quotes
        d: "starting address"                   ///// Write the option 4 inside double quotes
      },
      correctAnswer: "a"                ///// Write the correct option inside double quotes
    },  
    {
      question: "In general, the index of the first element in an array is __________",  ///// Write the question inside double quotes
      answers: {
